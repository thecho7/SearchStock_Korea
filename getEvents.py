...
class CpRpMarketWatch:
    ...
    def Request(self, code):
        ...
        # rqField = '1,2,3,4,5,6,7,10,11,12,13'
        # rqField = '8'
        rqField_ = range(13)
        for rqField in rqField_:
            ...
            # self.objpbMarket.Subscribe(code, self.caller)
            # self.objpbNews.Subscribe(code, self.caller)
            # print(self.caller)
        return True
 
# objMarketWatch = CpRpMarketWatch()
# objMarketWatch.Request('*')
# print(objMarketWatch.caller)